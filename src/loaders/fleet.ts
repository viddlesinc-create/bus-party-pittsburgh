...
export const fleetLoader: LoaderFunction<FleetData> = async () => {
  ...
  return {
    meta: {
      ...
      description: "Explore our premium fleet of party buses and limousines in Pittsburgh. Vehicles for 2-30 passengers with luxury amenities. View photos and features.",
      canonical: "/fleet"
    },
